...
class LegislationsControllerTest < ActionController::TestCase
  ...
  test "should create legislation" do
    assert_difference('Legislation.count') do
      post :create, legislation: { description: @legislation.description, name: @legislation.name, year_passed: @legislation.year_passed }
    end
  ...
  test "should update legislation" do
    patch :update, id: @legislation, legislation: { description: @legislation.description, name: @legislation.name, year_passed: @legislation.year_passed }
    assert_redirected_to legislation_path(assigns(:legislation))
  end
